          ...
          {[
            {
              ...
              texto: 'Line-up com artistas que misturam ritmos brasileiros, eletrônicos e experimentais. Prepare-se pra dançar até o amanhecer!'
            },
            {
              titulo: '🌌 Atmosfera imersiva',
              texto: 'Projeções, luzes, arte interativa e espaços temáticos que transformam o ambiente em uma experiência sensorial.'
            },
            {
              titulo: '🧘‍♀️ Espaços de bem-estar',
              texto: 'Área zen com redes, massagens gratuitas e oficinas de respiração para recarregar as energias durante o evento.'
            },
            {
              titulo: '🍴 Gastronomia regional',
              texto: 'Food trucks e barracas com sabores típicos da Amazônia e do cerrado — do açaí raiz ao tacacá gourmet.'
            },
            {
              titulo: '🌈 Inclusão & Diversidade',
              texto: 'Ambiente acolhedor com acessibilidade, respeito às identidades e celebração da pluralidade cultural.'
            },
            {
              titulo: '🎭 Performances Surpreendentes',
              texto: 'Artistas visuais, dançarinos e intervenções espontâneas que transformam o público em parte do espetáculo.'
            }
          ].map((card, index) => (
