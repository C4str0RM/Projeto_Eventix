...
function Pagamento() {
  ...
  const formas = [
    { nome: "Pix", icone: "⚡", descricao: "Transferência instantânea" },
    {
      ...
      icone: "📲",
      descricao: "Pague com PicPay, Mercado Pago ou PayPal",
    },
      ...
      <div className="container-pagamento">
        ...
        <div className="formas-section">
          ...
          <div className="opcoes-pagamento">
            ...
            <div
              className="metodo-box confirm-box"
              onClick={confirmarPagamento}
            >
              <strong>
                <span className="icone">✅</span> Confirmar Pagamento
              </strong>
              <p className="descricao">
                Finalize sua compra com a opção selecionada
              </p>
            </div>
          </div>
        </div>
